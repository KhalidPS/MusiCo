...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final DimezisLibraryAccessors laccForDimezisLibraryAccessors = new DimezisLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>dimezis</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public DimezisLibraryAccessors getDimezis() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForDimezisLibraryAccessors;
    }
    ...
    public static class ComposeLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>cloudy</b> with <b>com.github.skydoves:cloudy</b> coordinates and
         * with version reference <b>cloudy</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getCloudy() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("compose.cloudy");
        }
     ...
     */
    @Deprecated
    public static class DimezisLibraryAccessors extends SubDependencyFactory {

        public DimezisLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>blurview</b> with <b>com.github.Dimezis:BlurView</b> coordinates and
         * with version reference <b>blurviewVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getBlurview() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("dimezis.blurview");
        }
    ...
    public static class KoinLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>koinVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>blurviewVersion</b> with value <b>version-2.0.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getBlurviewVersion() { return getVersion("blurviewVersion"); }

        /**
         * Version alias <b>cloudy</b> with value <b>0.2.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCloudy() { return getVersion("cloudy"); }
        ...
        /**
         * Version alias <b>koinVersion</b> with value <b>4.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class BundleAccessors extends BundleFactory {
         ...
         *    <li>androidx.media3:media3-common-ktx</li>
         * </ul>
         * <p>
         * This bundle was declared in catalog libs.versions.toml
         *
